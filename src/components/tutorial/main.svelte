...
<main>
    <header>
        <h1 class="title animate-text-gradient"> Visualizer </h1>
        <h2 class="sub-title"> An Interactive Visualization Tool </h2>
    </header>

    <section id="landing-page-animation">
        <div class="floor"></div>
    </section>
    ...
    <article id="path-finding-tutorial">
        ...
        <p>
            Path Finding visualizer allows you to compare path finding algos and there implementation.
        </p>
    </article>
...
<style>
    ...
    .floor {
        ...
        border-radius: 50%;
        position: absolute;
        background-image: repeating-radial-gradient(var(--surface3), var(--surface1) 80%);
